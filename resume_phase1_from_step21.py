...
RESUME_SNAPSHOT_DIR = "snapshots_Phase1_first_core_resumed"
RESUME_STEP = 3

SNAPSHOT_DIR = "snapshots_Phase1_first_core_resumed2"
PLOT_DIR = "diagnostic_plots/run_Phase1_first_core_resumed2"
N_STEPS_MAX = 300
