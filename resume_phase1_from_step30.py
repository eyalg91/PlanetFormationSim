...
RESUME_SNAPSHOT_DIR = "snapshots_Phase1_first_core_resumed2"
RESUME_STEP = 9

SNAPSHOT_DIR = "snapshots_Phase1_first_core_resumed3"
PLOT_DIR = "diagnostic_plots/run_Phase1_first_core_resumed3"
N_STEPS_MAX = 400
