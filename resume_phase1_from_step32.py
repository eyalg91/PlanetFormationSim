...
RESUME_SNAPSHOT_DIR = "snapshots_Phase1_first_core_resumed3"
RESUME_STEP = 2

SNAPSHOT_DIR = "snapshots_Phase1_first_core_resumed4"
PLOT_DIR = "diagnostic_plots/run_Phase1_first_core_resumed4"
N_STEPS_MAX = 500
